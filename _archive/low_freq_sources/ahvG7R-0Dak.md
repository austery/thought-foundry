...
status: evergreen
summary: This guide details the architecture of a Python-based AI agent that converts
  natural language into data visualizations. It explores the single-shot code generation
  approach using LLMs, Streamlit, and Plotly, while analyzing the system's transparency,
